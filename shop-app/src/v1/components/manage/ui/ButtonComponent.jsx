...
const ButtonComponent = ({
  ...
  const colorClasses = {
    ...
    blue: "text-white bg-blue-700 hover:text-white hover:bg-blue-900 ",
    ...
    gray: "text-black bg-gray-200 hover:text-white hover:bg-gray-700 ",
  };
  const btnColor = colorClasses[color];
  return (
    <button
      className={`w-full text-md p-3 rounded-xs duration-300 select-none
        ${btnColor} 
